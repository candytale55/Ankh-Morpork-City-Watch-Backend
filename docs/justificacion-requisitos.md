...
[X] Al **eliminar la cuenta** de usuario se debe **eliminar la imagen** de cloudinary. 
...
- [X] Subida de ficheros con Cloudinary + eliminación de archivo cuando se elimina el dato
